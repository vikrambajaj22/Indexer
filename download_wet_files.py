...
# First, download the WET files file list (CC-MAIN-2018-39/wet.paths.gz) from http://commoncrawl.org/2018/10/september-2018-crawl-archive-now-available/ and extract it.
# Then, run this code.
...
# get the first 50 (feel free to customize)
first_50 = ['https://commoncrawl.s3.amazonaws.com/' + path.strip('\n') for path in file_paths[:50]]


# download the files and store them in the wet_files directory
i = 0
for path in first_50:
